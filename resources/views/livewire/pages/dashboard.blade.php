    ...
    <div class="grid grid-cols-3 gap-4 mb-4">
        <div class="p-6 h-42 rounded-xl bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                ...
                <div
                    class="flex items-center justify-center hidden p-2 bg-blue-100 rounded-lg md:block dark:bg-blue-400/10">
        ...
        <div class="p-6 h-42 rounded-xl bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                ...
                <div
                    class="flex items-center justify-center hidden p-2 bg-orange-100 rounded-lg md:block dark:bg-orange-400/10">
        ...
        <div class="p-6 h-42 rounded-xl bg-gray-50 dark:bg-gray-800">
            <div class="flex items-center justify-between">
                ...
                <div
                    class="flex items-center justify-center hidden p-2 rounded-lg md:block bg-cyan-100 dark:bg-cyan-400/10 ">
    ...
    <div class="grid grid-cols-4 gap-4 mb-4">
        ...
        <div class="hidden p-6 lg:block rounded-xl bg-gray-50 dark:bg-gray-800">
            ...
            <div class="flex items-center gap-3">
                ...
                <p class="text-gray-600 dark:text-gray-300 font-regular">Richard Jones has purchased a
                    Fjallraven - Foldsac for $109.95</p>
            </div>
            ...
            <div class="flex items-center gap-3">
                ...
                <p class="text-gray-600 dark:text-gray-300 font-regular">Sara Smith has registered as a new
                    customer</p>
            </div>
